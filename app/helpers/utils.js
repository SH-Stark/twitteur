import { usersTweetsExpirationLength, userExpirationLength, repliesExpirationLength } from 'config/constants';
...
export function staleTweets (timestamp) {
  return getMilliseconds(timestamp) > usersTweetsExpirationLength;
}
